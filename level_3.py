...
def thirdlevel():
    ...
    answer_a = {
        "solution":"no",
        "help":["Do you call yourself a Potter Head?", "They wouldn't survive the last round..."]
        }
    answer_b = {
        "solution":"yes",
        "help":["Bro what els could be so horizonta", "Y"]
        }
    answer_c = {
        "solution":"yes",
        "help":["Theres allways a correct way of seeing things...", "You should take a couple hours and a bucket of popcorn and find the answer"]
        }
    answer_d = {
        "solution":"yes",
        "help":["MAY", "The 25th"]
    ...
    answer_e = {
        "solution":"no",
        "help":["If you have to ask you are not a true jedi...", "Lets say the breathing sounds were never the same..."]
        }
    answer_f = {
        "solution":"yes",
        "help":["Im disappointed....", "You are not a true wizard......"]
        }

    
    
    quizzs_s = {
        "Does the Harry Potter saga has 9 movies?" : answer_a,
        "Did the StarTrek vulcan hand gesture represents Live long and prosper?" : answer_b,
        "Should you watch the StarWars movies in this order 456123?" : answer_c,
        "Is the Nacional Nerd Pride day in the 25th of May?" : answer_d,
        "Are StarWars Disney movies good?" : answer_e,
        "Is Gandalf a freaking BADASS?" : answer_f,
